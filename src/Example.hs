...
myEq3 x (MyValue a) (MyValue b) = $(enumerateConstructors' ''MyType [|a == b|]) x

-- What we really want is:
-- myEq4 :: Sing a -> MyValue a -> MyValue a -> Bool
-- myEq4 x (MyValue a) (MyValue b) = $(enumerateConstructors' x [| a == b |]) x
